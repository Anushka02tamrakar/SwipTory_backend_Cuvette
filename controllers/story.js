...
//     const { userId, category, catLimit, cat } = req.query;    //object destructuring
...
//                     story.slides.some((slide) => slide.category === c)
//                 );
//                 groupedStories[c] = categoryStories.slice(0, cat === c ? (catLimit || categoryStories.length) : 4);
//             }
...
//                 },
//                 {
//                     $match: { "slides.catagory": category },
//                 },
//                 {
//                     $group: {
//                         _id: "$_id",
...
//             if (user) {
//                 //check if user has likes/bookmarked the story
//                 const liked = user.likes.includes(storyId);
//                 const bookmarked = user.bookmarks.includes(storyId);
...
//         if (!story) {
//             res.status(404).json({ error: "Stroy not found" });
//         }
...
// module.exports = { createStory, getStories, getStoryById, updateStory };
